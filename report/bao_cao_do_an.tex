...
\subsubsection{Các phương pháp xử lý Outliers}

\begin{table}[H]
\centering
\caption{So sánh các phương pháp xử lý Outliers}
...
\texttt{plot\_target\_analysts()} & 
Phân tích target : distribution, correlations, box plot.Kiểm tra normarity \\
\hline
